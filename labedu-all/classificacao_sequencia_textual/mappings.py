...
class ConnectorsMap:
  ...
  def tokens():
    return {
      ...
      'CON-CND': sorted(['a medida que', 'a menos que', 'a não ser que', 'caso', 'contanto que', 'desde que', 'exeto se', 'salvo se', 'sem que'], reverse=True),
      ...
      'CON-TCA': sorted(['então'], reverse=True),
    }
